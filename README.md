...
8. Add necessary library files of LCD 16x2 , write the program and use project and build  
...
13. After creation of the circuit as per requirement as shown below 

14. Next to the Program File option, give full path to the Hex file generated using STM32Cube IDE. Then set the external crystal frequency to 8M (i.e. 8 MHz). Click OK to save the changes.
...
![image](https://github.com/ANU23000217/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/139117108/73d2e9c1-6bda-41d7-80db-dfd69ffe6e0a)

 
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

![image](https://github.com/ANU23000217/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/139117108/16b12b33-2e9a-4b4b-8b72-bdd18984951b)
